...
class Calculator3
{
    ...
    {
       MarvellousCalculator fobj = new MarvellousCalculatr (400, 400,"Marvellous");
...
b3.setBounds(290,280,80,40);//X,Y,W,H
...
t2.setBounds(220,100,100,40);//X,Y,W,H
    ...
    public void
     windowClosing(WindowEvent obj)// Event handler for frame
    {
        System.exit(0);
    }
      public void
      actionPerformed(ActionEvent aobj) // Event handler for buttons 
      {
          try 
          {
            ...
            {
                lobj.setText("Devision is :"+(No1/No2));
            }
        }
